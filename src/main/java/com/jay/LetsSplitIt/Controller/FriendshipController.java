...
public class FriendshipController {
    ...
    @GetMapping
    public ResponseEntity<List<UUID>> listFriends(@AuthenticationPrincipal UserDetails userDetails) {
        return ResponseEntity.ok(friendshipService.listAcceptedFriendIds(userDetails));
    }
